...
const MyChatWidgetGUID = "b2dfd305-ac8c-11ed-89a4-06b1006a3247";
...
const IMI_SMS_WEBHOOK = "https://hooks.us.webexconnect.io/events/TBUY8AR780";
//This is the URL for requesting and callback, the WxConnect Script runs a HTTP POST to initial a call back request.
const IMI_CALLBACK_WEBHOOK = "https://hooks.us.webexconnect.io/events/6UOEYAB234";
...
const TOKEN_SERVICE_URL = "https://us-central1-gcp-ruegreen-nprd-41696.cloudfunctions.net/token-service?name=Token_Name";
const TOKEN_SERVICE_PASSPHRASE = "yourpassword";
const JDS_PROJECTID = "64b55afb6d82725e4ec46e45";
//DONT CHANGE THIS!!
