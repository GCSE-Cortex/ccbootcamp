...
//This is the outdial entry point ID in WxCC
const WXCC_CALLBACK_ENTRYPOINTID = "3ac63211-3fa4-48d8-8042-98cbe4c1fd74";
...
const TOKEN_SERVICE_USERID = "M3aWaYtQr9euTaLgg3SqQ3s4Efq2";
...
(async () => {
  ...
  //Button to open Offcanvas menu
    ...
    btn.setAttribute("style", `Bottom:70%; right:0; position:fixed; transform:rotate(-90deg); transform-origin:100% 100%; color:#ffffff; background-color:#0b63ac; border-color:@0b63ac;`);
...
// Disabling token fetch since update JDS is disabled
/*
  ...
  try {
    ...
    const response = await fetchWithTimeout(IMI_CALLBACK_WEBHOOK, {
      ...
      body: JSON.stringify({
        ...
        entrypointid: WXCC_CALLBACK_ENTRYPOINTID,
...
//Disabling JDS Update in Scripty due to CORS error //
/*
...
async function sendSMS() {
  try {
    ...
    smsLanguage.value = "";
      ...
      switch (language) {
        case "Spanish" :
          successMessage.innerHTML = `Nosotras enviamos un sms a tu numero ${formatPhoneNumber(number)}.`;
          break;
        case "French" :
          successMessage.innerHTML = `Nous avons envoyé un SMS à votre numéro ${formatPhoneNumber(number)}.`;
          break;
        case "Portuguese" :
          successMessage.innerHTML = `Enviamos um SMS para o seu número ${formatPhoneNumber(number)}.`;
          break;
        case "Italian" :
          successMessage.innerHTML = `Ti abbiamo inviato un SMS al numero ${formatPhoneNumber(number)}.`;
          break;
        default:
        ...
        <div class="modal-body">
          <form id="callbackForm" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
              ...
              <input type="tel" class="form-control" id="callbackNumber" pattern="[0-9]{10}" placeholder="Enter your callback number" required />
        ...
        <div class="modal-body">
          <form id="smsForm" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
              ...
              <input type="tel" class="form-control" id="smsNumber" pattern="[0-9]{10}" placeholder="Enter your mobile number" required />
              <div class="invalid-feedback">Enter a 10-digit mobile number</div>
            </div>
            <div class="mb-3">
              <label for="smsLanguage" class="form-label">Preferred Language</label>
              <select class="form-select" id="smsLanguage" required>
