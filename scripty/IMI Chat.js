...
function addElement() {
  ...
  div.id = "divicw";
  div.setAttribute("data-bind", MyChatWidgetGUID);
  div.setAttribute("data-org", "");
  ...
  var i = {
    ...
    o: function (t) {
      //t.insertAdjacentHTML("afterend", '<iframe id="tls_al_frm" frameborder="0" style="overflow: hidden;height: 208px;width: 394px;position: fixed;display: block;left: 48px;bottom: 12px;z-index: 99999; display:none;"></iframe>');
